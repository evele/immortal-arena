...
```text
finalDamage = max(0, adjustedDamage - defenderDefense)
```
...
4. Subtract the defender's full Defense stat from the adjusted damage.
...
7. There is no minimum damage floor.
